...
<head>
    ...
    <link href="<%=request.getContextPath() %>/frontstage/memberFrontend/member/css/get-all.css" rel="stylesheet" />
</head>
<body>
    <!-- Topbar Start -->
    ...
    <div id="main-content2">  
        ...
        <form action="<%=request.getContextPath()%>/member/member.do" method="post">
            ...
            <br>
            <a href="<%=request.getContextPath()%>/frontstage/backend/admin/memberindex.jsp">回首頁</a>
        </form>
    </div>
