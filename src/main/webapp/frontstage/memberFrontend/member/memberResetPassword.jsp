...
<body>
    <h2>重設密碼</h2>
    <form id="resetPasswordForm" action="/TIA102G4/memberResetPassword" method="POST">
    ...
    <script>
        $(document).ready(function() {
            $('#resetPasswordForm').submit(function(event) {
                ...
                $.post('/TIA102G4/memberResetPassword', formData, function(response) {
                    if (response.success) {
                        showModal('密碼重設成功!', function() {
...
<!-- <body> -->
<!--     <h2>重設密碼</h2> -->
<!--     <form id="resetPasswordForm" action="/C080604/resetPassword" method="POST"> -->
<%--         <input type="hidden" name="resetToken" value="${resetToken}"> --%>
...
<!-- //                 var formData = $(this).serialize(); -->
<!-- //                 $.post('/C080604/resetPassword', formData, function(response) { -->
<!-- //                     if (response.success) { -->
<!-- //                         alert('密碼重設成功!'); -->
