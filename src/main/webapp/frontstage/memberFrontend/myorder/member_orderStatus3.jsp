...
<body style="background-color: #F3F6FF;">
	...
	<div class="bodycontent">
		...
		<div class="main_content1" style="background-color: #F3F6FF;">
			...
			<button class="member_reser3" style="background-color: #ffc107;">
				<a style="color: black; text-decoration: none;"
							...
							<div class="edit_cancel">
								<div class="edit_order1">
									<form
										...
										<button type="submit" class="edit-button favorite1">收藏</button>
									</form>
								</div>

								<div class="cancel_order">
									<a type="button" class="cancel-button">評價</a>
								</div>
							</div>
						</div>
					</div>
