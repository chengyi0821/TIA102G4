...
<link
	...
	rel="stylesheet" />
<link
	href="<%=request.getContextPath()%>/frontstage/backend/admin/css/adminUpdate.css"
	rel="stylesheet" />
	...
	<div id="main-content2">
		...
		<form action="<%=request.getContextPath()%>/admin/admin.do"
			...
			<label for="name">姓名:</label> <input type="text" id="name"
				name="name" value="${admin.name}" required /><br /> <label
				for="account">帳號:</label> <input type="text" id="account"
				name="account" value="${admin.account}" required /><br /> <label
				for="password">密碼:</label> <input type="password" id="password"
				name="password" value="${admin.password}" required /><br /> <label
				for="permission">權限:</label> <input type="number" id="permission"
				name="permission" min="1" max="3" value="${admin.permission}"
				required /><br />
