...
<body>
    ...
    <form id="forgotPasswordForm" action="${pageContext.request.contextPath}/restForgotPassword" method="POST">
    ...
    <script>
        $(document).ready(function() {
            $('#forgotPasswordForm').submit(function(event) {
                ...
                $.post('${pageContext.request.contextPath}/restForgotPassword', formData, function(response) {
                    if (response.success) {
