...
<body>
    <h2>Chugether - 餐廳重設密碼</h2>
    <form id="resetPasswordForm" action="${pageContext.request.contextPath}/restResetPassword" method="POST">
    ...
    <script>
        $(document).ready(function() {
            $('#resetPasswordForm').submit(function(event) {
                ...
                $.post('${pageContext.request.contextPath}/restResetPassword', formData, function(response) {
                    if (response.success) {
                        alert('密碼重設成功，請重新登入！');
                        window.location.href = 'restLogin.jsp';
                    } else {
