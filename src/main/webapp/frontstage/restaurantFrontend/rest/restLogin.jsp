...
<body>
    <h2>Chugether - 餐廳登入</h2>

    <form id="restLoginForm" action="${pageContext.request.contextPath}/restLogin" method="POST">
        ...
        <div class="links-container">
            <a href="restForgotPassword.jsp">Forgot Password 忘記密碼</a>
            <a href="restRegister.jsp">Register 餐廳註冊</a>
        </div>
    </form>
    ...
    <script>
        $(document).ready(function() {
            $('#restLoginForm').submit(function(event) {
                event.preventDefault();

                var formData = $(this).serialize();
                $.post('${pageContext.request.contextPath}/restLogin', formData, function(response) {
                    if (response.success) {
                        showModal('登入成功! 歡迎來到Chugether* 一起來揪團吧!', function() {
                            window.location.href = 'restMain.jsp';
                        });
                    } else {
