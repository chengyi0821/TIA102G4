...
<%-- 							<img class="logo" src="<%=request.getContextPath() %>/frontstage/memberFrontend/myorder/image/logo.png"> --%>
								<h1 class="m-0 display-4 text-primary">&nbsp&nbsp&nbsp&nbsp&nbsp&nbspChugether</h1>
						</a>
					</div>
				</div>
			</div>
				...
				<div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
					<div class="navbar-nav ml-auto py-0">
					  <div class="orderblock">  <a href="#" class="nav-item nav-link">會員中心</a>
						<ul class="orderlist">
							<li><a style="color: black;" href="#<%=request.getContextPath() %>/frontstage/restaurantFrontend/restaurantEdit/restaurantEdit.html">修改資料</a></li>
				...
				<div class="blist">
					...
					<c:forEach var="blacklist" items="${blackListList}">
						<ul class="blist_detail">
							...
							<li>黑名單新增時間：${fn:substring(blacklist.addBlistTime, 0, 19)}</li>
							<form method="post"
								action="<%=request.getContextPath() %>/blacklist/blacklist.do"
