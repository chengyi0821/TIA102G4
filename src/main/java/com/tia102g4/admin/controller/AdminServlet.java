...
public class AdminServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		case "resetPassword":
			...
			break;
		case "getById":
			forwardPath = getByAdminId(req, res);
			break;
		default:
	...
	private String getByAdminId(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
	    Long adminId = Long.parseLong(req.getParameter("adminId"));
	    System.out.println("getByAdminId: adminId = " + adminId);

	    Admin admin = adminService.getAdminByAdminId(adminId);
	    if (admin != null) {
	        req.setAttribute("admin", admin);
	        System.out.println("getByAdminId: Admin found: " + admin);
	        // 不進行 forward
	        return "/frontstage/backend/admin/adminupdate.jsp";
	    } else {
	        req.setAttribute("errorMessage", "會員未找到!");
	        System.out.println("getByAdminId: Admin not found.");
	        // 不進行 forward
	        return "/frontstage/backend/admin/adminupdate.jsp";
	    }
	}
